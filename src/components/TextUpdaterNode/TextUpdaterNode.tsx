...
export const TextUpdaterNode = ({ data, id }: NodeProps) => {
  ...
  const { handleUpdatePrompt, handleUpdateAnswer, studyMode } = useStore(
    selector,
    shallow,
  );
        ...
        <Form>
          ...
          <Input
            ...
            onChange={(event: React.ChangeEvent<HTMLInputElement>) =>
              handleUpdatePrompt(id, event.target.value)
            }
            className="nodrag"
          />
