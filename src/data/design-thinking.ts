...
export const designThinkingNodes = [
  ...
  },
  {
    ...
    data: {
      ...
      answer:
        "Problems for which neither question nor answer is well-defined. Like, how to decrease traffic accidents? How to fix global warming?",
      grade: {
        interval: 0,
        repetition: 0,
        efactor: 2.5,
  ...
  },
  {
    ...
    data: {
      ...
      answer:
        "By using design thinking, you make decisions based on what customers really want instead of relying only on historical data or making risky bets based on instinct instead of evidence.",
      grade: {
        interval: 0,
        repetition: 0,
        efactor: 2.5,
  ...
  },
  {
    ...
    data: {
      ...
      answer:
        "Empathy is a journey into the feelings of others, it gives you the insights you need to solve hard, worthwhile problems.",
      grade: {
        interval: 0,
        repetition: 0,
        efactor: 2.5,
